...
function Sidebar(){
    ...
    return (
        ...
        <IconContext.Provider value={{color: '#71C562'}}>
            ...
            <nav className={sidebar ? 'bg-white w-full h-screen flex justify-center absolute left-0 top-0 duration-300 z-40 md:w-64' : 'bg-white w-full h-screen flex justify-center fixed top-0 left-[-100%] duration-700 z-40 md:w-64'}>
