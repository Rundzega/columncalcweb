...
export function RebarTable() {
    ...
    return (
        ...
        <div className={state.rebarList.length > 0 ? "border-brandGreen-300 border-[1px] h-full w-full mb-3 rounded-2xl overflow-hidden max-h-[182px] outline-none ring-0" : "md:border-brandGreen-300 border-[1px] h-full w-full mb-3 rounded-2xl overflow-hidden max-h-[182px] outline-none ring-0"  }>
